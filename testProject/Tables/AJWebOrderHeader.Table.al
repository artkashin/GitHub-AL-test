table 37074833 "AJ Web Order Header"
{
    ...
    fields
    {
        ...
        field(80;"Ship-From Warehouse ID";Code[40])
        {
            TableRelation = IF ("Shipping Web Service Code"=CONST('')) "AJ Web Service Warehouse"."Warehouse ID" WHERE ("Web Service Code"=FIELD("Web Service Code"))
                            ELSE IF ("Shipping Web Service Code"=FILTER(<>'')) "AJ Web Service Warehouse"."Warehouse ID" WHERE ("Web Service Code"=FIELD("Shipping Web Service Code"));
